...
from fastapi import FastAPI, HTTPException, Request, Depends, Header, UploadFile, File, Form, Query`nfrom fastapi.staticfiles import StaticFiles
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
)`napp.mount("/", StaticFiles(directory=".", html=True), name="static")
